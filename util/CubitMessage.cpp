...
CubitMessage::CubitMessage()
{
  ...
  static MessageFlag staticDebugFlag[] =
  {
    ...
    MessageFlag(178, "Enable old Harris hex refinement instead of new Parrish hex refinement"),
    MessageFlag(179, "Enable Camal Sweeper for UCP Front Advancements.  Ignored if debug 189 is on"),
    ...
    MessageFlag(189, "Enable Tri-Based Surface offset in UCP.  Takes precedence over debug flag 179.\n" ),
    MessageFlag(190, "unused placeholder\n" ),
    MessageFlag(191, "Auto clean messages\n" ),
    MessageFlag(192, "MBG - nonmanifold edge check\n" ),
    MessageFlag(193, "unused placeholder\n" ),/*before you used this*/
    MessageFlag(194, "unused placeholder\n" ),/*one make sure that */
    MessageFlag(195, "unused placeholder\n" ),/* 187 - 190 are used.*/
    MessageFlag(196, "unused placeholder\n" )
